...
SELECT course_number,course_name,course_description,class_hours,term_id AS "semester",season_name,education_type,lab_hours,homework_hours,COURSES_PACKAGE.calculate_total_hours(class_hours,lab_hours) AS "total hours",domain_name,description AS "domain description" FROM dawson_courses
...
SELECT comp_name,COMPETENCIES_PACKAGE.find_specification(specification) AS "specification",comp_description,element_name,element_description FROM competencies
